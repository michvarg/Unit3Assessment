...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final Object CheckBox = remember_username_checkbox ;
    private static final Object Button = email_sign_in_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox = (CheckBox) findViewById(R.id.remember_username_checkbox);
